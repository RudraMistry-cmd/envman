...
> Cached: 2026-09-06T08:01:05.878Z
...
Sponsored OSSBy [The Apache Software Foundation](/u/apache)

•Updated 2 months agoApache Kafka

ImageMessage queuesData scienceMonitoring & observability**218**10M+

[Overview](/r/apache/kafka)[Tags](/r/apache/kafka/tags)# apache/kafka repository overview
...
Copy
#### [⁠](#overriding-the-default-broker-configuration)Overriding the default broker configuration
...
- `KAFKA_PROCESS_ROLES` is either `broker` or `controller` depending on the container&#x27;s role, not the KRaft combined mode value `broker,controller`

- `KAFKA_CONTROLLER_QUORUM_VOTERS` is a comma-separated list of the three controllers
