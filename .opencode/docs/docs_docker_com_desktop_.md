...
> Cached: 2026-09-10T08:35:11.720Z
...
that lets you build, share, and run containerized applications and microservices.It provides a straightforward GUI (Graphical User Interface) that lets you manage your containers, applications, and images directly from your machine.
...
Mac,
Windows, or
Linux.### Learn about Docker Desktop

Navigate Docker Desktop.
...
Networking,
Docker VMM,
WSL, and more.### View the release notes
